 ...
 *
 * - The {@link ca.bc.gov.repository.library.java.net.openid.appauth.AuthorizationService.TokenResponseCallback response} to
 * {@link AuthorizationService#performTokenRequest(ca.bc.gov.repository.library.java.net.openid.appauth.TokenRequest,
...
public final class AuthorizationException extends Exception {
     ...
     * {@link #toIntent()}.
     */
    public static final String EXTRA_EXCEPTION = "ca.bc.gov.repository.library.java.net.openid.appauth.AuthorizationException";
