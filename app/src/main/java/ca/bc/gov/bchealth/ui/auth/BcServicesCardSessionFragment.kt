 ...
 * [BcServicesCardSessionFragment] is representing state when the auth token is expired.
    ...
    override fun GetComposableLayout() {
        MyHealthTheme {
            Scaffold(
                ...
                content = {
                    BCServicesCardSessionScreen(modifier = Modifier.padding(it), type = args.source) {
