...
fun OrganDonorStatus.toDto() = when (this) {
    OrganDonorStatus.UNKNOWN -> OrganDonationStatus.UNKNOWN
    OrganDonorStatus.ERROR -> OrganDonationStatus.ERROR
    OrganDonorStatus.PENDING -> OrganDonationStatus.PENDING
    OrganDonorStatus.NOT_REGISTERED -> OrganDonationStatus.NOT_REGISTERED
    OrganDonorStatus.REGISTERED -> OrganDonationStatus.REGISTERED
}
